...
public class SelectionManagerUnitTest {
	...
	public void testPredicate() {
		...
		Assert.assertSame(selection, mSelectionManager.getSelection());
	...
	private class MyTextureParagraph implements TextureParagraph {
		...
		@Override
		public void render(@NonNull Paragraph paragraph, @NonNull PaintSet paintSet, @NonNull RenderOption renderOption, @NonNull SelectionMethod selectionMethod) {
