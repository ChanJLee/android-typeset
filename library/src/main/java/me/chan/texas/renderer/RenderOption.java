...
public class RenderOption {
	...
	/**
	 * @return 获取span选中后背景的颜色 {@link me.chan.texas.text.Paragraph.Builder#newSpanBuilder(OnClickedListener)}
	 */
	 ...
	 * 设置点击span后的背景色
	 *
	 * @param selectedSpanBackgroundColor 颜色 {@link me.chan.texas.text.Paragraph.Builder#newSpanBuilder(OnClickedListener)}
	 * @return 当前对象
	 */
	...
	/**
	 * @return 返回span选中后的颜色 {@link me.chan.texas.text.Paragraph.Builder#newSpanBuilder(OnClickedListener)}
	 */
	 ...
	 * 设置span选中后的颜色
	 *
	 * @param spanSelectedTextColor 颜色 {@link me.chan.texas.text.Paragraph.Builder#newSpanBuilder(OnClickedListener)}
	 * @return 当前对象
	 */
	 ...
	 * <p/>
	 * {@link me.chan.texas.text.Document#addSegment(Segment)}
	 * {@link me.chan.texas.text.Paragraph}
	 * {@link me.chan.texas.text.ViewSegment}
	 * {@link me.chan.texas.text.Figure}
	 */
