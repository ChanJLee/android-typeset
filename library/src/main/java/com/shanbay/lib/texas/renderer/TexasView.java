...
public final class TexasView extends FrameLayout {
	 ...
	 *
	 * @param position segment index {@link Document#indexOfSegment(Segment)} {@link com.shanbay.lib.texas.text.Paragraph}
	 ...
	 * 滚动到document的某个segment
	 *
	 * @param position segment index {@link Document#indexOfSegment(Segment)} (Segment)} {@link com.shanbay.lib.texas.text.Paragraph}
	 * @param smooth   滚动的时候是否平滑滚动
	...
	public interface SelectionPredicate {
		 ...
		 * @param spanTag      {@link com.shanbay.lib.texas.text.Paragraph.SpanBuilder#tag(Object)}
		 * @return 是否选中
		 */
		@Idempotent
	...
	public interface HighlightPredicate {
		/**
		 * @param paragraphTag {@link com.shanbay.lib.texas.text.Paragraph.Builder#tag(Object)}
		 * @param spanTag      {@link com.shanbay.lib.texas.text.Paragraph.SpanBuilder#tag(Object)}
	...
	/**
	 * use {@link com.shanbay.lib.texas.renderer.OnSpanClickedPredicate} instead
	 */
	@Deprecated
	public interface OnSpanClickedPredicate extends com.shanbay.lib.texas.renderer.OnSpanClickedPredicate {
	}

	/**
	 * use {@link com.shanbay.lib.texas.renderer.OnSpanLongClickedPredicate} instead
	 */
	@Deprecated
	public interface OnSpanLongClickedPredicate extends com.shanbay.lib.texas.renderer.OnSpanLongClickedPredicate {
	}
