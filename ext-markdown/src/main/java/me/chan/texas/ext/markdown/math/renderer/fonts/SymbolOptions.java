...
public class SymbolOptions {
	...
	public SymbolOptions() {
		...
		Po.put("exclamdown", new Symbol("\u00A1"));
		// SECTION SIGN §
		Po.put("section", new Symbol("\u00A7"));
		// PILCROW SIGN ¶
		Po.put("paragraph", new Symbol("\u00B6"));
		// MIDDLE DOT ·
		Po.put("periodcentered", new Symbol("\u00B7"));
		// INVERTED QUESTION MARK ¿
		Po.put("questiondown", new Symbol("\u00BF"));
		// DOUBLE VERTICAL LINE ‖
		Po.put("dblverticalbar", new Symbol("\u2016"));
		// DOUBLE LOW LINE ‗
		Po.put("uni2017", new Symbol("\u2017"));
		// DAGGER †
		Po.put("dagger", new Symbol("\u2020"));
		// DOUBLE DAGGER ‡
		Po.put("daggerdbl", new Symbol("\u2021"));
		// BULLET •
